#==============================================================================
#   Description
#       module which fill the missing data of the station observations through
...
class FillGap():
    ...
    def fillstation(self, stanames, all=None, plot = None, summary = None, From=None, To=None):
        ...
        INPUT
            ...
            all, if none fill all the stations
        """
        if all == True:
...
if __name__=='__main__':
    InPath='/data1/DATA/EXTREMA/STORAGE/data/C/merge/'
    OutPath= '/data1/DATA/EXTREMA/STORAGE/data/C/full/'
    Files=glob.glob(InPath+"*merge.txt")
    print Files
    net=LCB_net()
    # AttSta = att_sta()
