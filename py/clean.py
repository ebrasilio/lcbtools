...
#===========================================================================
      # InPath='/data1/DATA/EXT/STORAGE/data/C/raw'
      # OutPath='/data1/DATA/EXT/STORAGE/data/C/clean_test/'
      # logpath = '/data1/DATA/EXT/STORAGE/data/C/log/'
      #
...
##===============================================================================
## 2) Merge, reconstruct and filter the data
##===============================================================================
        InPath = '/data1/DATA/EXTREMA/STORAGE/data/C/clean_test'
        OutPath = '/data1/DATA/EXTREMA/STORAGE/data/C/merge/'

        stations = ['C04','C05','C06','C07','C08','C09','C10','C11','C12','C13','C14','C15','C16','C17','C18','C19']
        # stations = ['C05']
        ...
        for sta in stations:
            ...
            for i in matches:
                managedata = ManageDataLCB(os.path.dirname(i) + "/", os.path.basename(i),
                                           sta)  # create an instance of managedatalcb object
                try:
            ...
            datamerge.write_dataframe(OutPath, sta + 'clear_merge', resample=['H', 'D'])  # write the dataframe
